...
<table border=1>
	...
	<tr><th>名前</th><th><input id="new-name" type="text" name="newName" required>
	</th></tr><tr><th>電話番号</th><th><input id="new-phone" type="text" name="newPhone"><br>
	</th></tr><tr><th>誕生日</th><th>
...
<select name="day" >
	...
	<br>
   	...
   	</th></tr><tr><th>話したことが</th><th>
		<select name="talkFlag">
  		<option value="">選択してください</option>
  		<option value="1">ある</option>
  		<option value="0" selected>ない</option>
   		</select>
		
	</th></tr><tr><th>ノート</th><th>
		<textarea name="note" cols=40 rows=4></textarea></th></tr></table>
  	
  	<a href='${f:url("/recomemberList")}'>一覧</a>	
	<input type="submit" name="RecomemberRegisterConfirm" value="確認">
